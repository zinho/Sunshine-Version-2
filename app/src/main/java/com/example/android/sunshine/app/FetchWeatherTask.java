...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if ( cursor.moveToFirst() ) return cursor.getLong(cursor.getColumnIndex(LocationEntry._ID));
        ...
        if ( _id < 1 ) throw new android.database.SQLException("Failed to insert row");
